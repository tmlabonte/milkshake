...
Note that milkshake is a GitHub template: it is intended for use as a foundation which makes it easy to add your own research code. Currently, there are 8 datasets and 6 models implemented across both vision and language tasks; contributions of models and datasets are welcomed!
